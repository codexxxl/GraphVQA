...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    progress = ProgressMeter(
        ...
        [
            ...
            bitmap_precision, bitmap_recall,
            full_answer_acc, short_answer_acc
        ],
    ...
    with torch.no_grad():
        ...
        for i, (data_batch) in enumerate(val_loader):
            ...
            if FAST_VALIDATE_FLAG:
                ...
                programs_output_pred, full_answers_output_pred, short_answer_logits, execution_bitmap = output
            ...
            if DUMP_RESULT:
                ...
                for batch_idx in range( this_batch_size ):
                    ...
                    quesid2ans[qid] = {
                        ...
                        "fullAnswer": gt_sent,
                        "predicted_fullAnswer": pred_sent,
