...
This repo provides the source code of our paper: [GraphVQA: Language-Guided Graph Neural Networks for Scene Graph Question Answering](https://arxiv.org/abs/2104.10283) (NAACL 2021 MAI Workshop).
```
